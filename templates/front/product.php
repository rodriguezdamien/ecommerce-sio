                ...
                <div id="product-info" data-id="<?= htmlspecialchars($params['product']->GetId()) ?>">
                    ...
                    <div class="mt-12 flex justify-center md:block">
                        ...
                        >
                            ...
                            <div id="action-container" class="relative flex items-center justify-center lg:justify-start gap-1">
                                ...
                                <div id="cart-info" class="absolute flex invisible flex-col items-center opacity-1 -bottom-16 w-[70vw] md:w-80" style="transform:translateY(-10px)">
